# Requisition Management System — Project Wiki

Welcome to the **Requisition Management System API** developer wiki. This documentation provides a comprehensive architectural and technical reference for developers, DevOps engineers, and system integrators.
...
| # | Topic | Description |
| :--- | :--- | :--- |
| **01** | [Architecture & Design](01-Architecture-and-Design.md) | Clean Architecture layers, service patterns, request lifecycle, and design principles. |
| **02** | [Domain Model & Database](02-Domain-Model-and-Database.md) | Database schema, ER diagram, Eloquent models, casts, enums, relationships, and migrations. |
| **03** | [Authentication & Authorization](03-Authentication-and-Authorization.md) | Laravel Sanctum token auth, user roles, policies, and gate security matrix. |
